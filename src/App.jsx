...
class App extends Component {
  ...
  // This syntax automatically binds `this` to the function if used as a callback
  ...
  render() {
    ...
    return (
      <div>
        ...
        <ChatBar currentUser={this.state.currentUser.name} handleNewMessage={this.handleKeyPress} updateCurrentUser={this.updateCurrentUser}/>
      </div>
    );
  }
}
